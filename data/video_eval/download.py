...
# hf_hub_download(repo_id="TIGER-Lab/Video_Eval", filename="all_50k/train_50k_for_mantis/data_inc.json", repo_type="dataset", local_dir="./data")
...
# hf_hub_download(repo_id="TIGER-Lab/Video_Eval", filename="all_50k/train_50k_for_mantis/frames_inc.zip", repo_type="dataset", local_dir="./data")


# hf_hub_download(repo_id="TIGER-Lab/Video_Eval", filename="all_50k/train_95k_resampled_for_mantis/data_insf.json", repo_type="dataset", local_dir="./data")
# hf_hub_download(repo_id="TIGER-Lab/Video_Eval", filename="all_50k/train_95k_resampled_for_mantis/data_lab.json", repo_type="dataset", local_dir="./data")
# hf_hub_download(repo_id="TIGER-Lab/Video_Eval", filename="all_50k/train_95k_resampled_for_mantis/data_real.json", repo_type="dataset", local_dir="./data")
# hf_hub_download(repo_id="TIGER-Lab/Video_Eval", filename="all_50k/train_95k_resampled_for_mantis/data_static.json", repo_type="dataset", local_dir="./data")
# hf_hub_download(repo_id="TIGER-Lab/Video_Eval", filename="all_50k/train_95k_resampled_for_mantis/data_worsen_gen.json", repo_type="dataset", local_dir="./data")
# hf_hub_download(repo_id="TIGER-Lab/Video_Eval", filename="all_50k/train_95k_resampled_for_mantis/data_inc.json", repo_type="dataset", local_dir="./data")
# hf_hub_download(repo_id="TIGER-Lab/Video_Eval", filename="all_50k/train_95k_resampled_for_mantis/data_avg_resmp_0.json", repo_type="dataset", local_dir="./data")
# hf_hub_download(repo_id="TIGER-Lab/Video_Eval", filename="all_50k/train_95k_resampled_for_mantis/data_avg_resmp_1.json", repo_type="dataset", local_dir="./data")
# hf_hub_download(repo_id="TIGER-Lab/Video_Eval", filename="all_50k/train_95k_resampled_for_mantis/data_avg_resmp_2.json", repo_type="dataset", local_dir="./data")
# hf_hub_download(repo_id="TIGER-Lab/Video_Eval", filename="all_50k/train_95k_resampled_for_mantis/data_avg_resmp_3.json", repo_type="dataset", local_dir="./data")
# hf_hub_download(repo_id="TIGER-Lab/Video_Eval", filename="all_50k/train_95k_resampled_for_mantis/data_avg_resmp_4.json", repo_type="dataset", local_dir="./data")
# hf_hub_download(repo_id="TIGER-Lab/Video_Eval", filename="all_50k/train_95k_resampled_for_mantis/data_avg_resmp_5.json", repo_type="dataset", local_dir="./data")
# hf_hub_download(repo_id="TIGER-Lab/Video_Eval", filename="all_50k/train_95k_resampled_for_mantis/data_avg_resmp_6.json", repo_type="dataset", local_dir="./data")
# hf_hub_download(repo_id="TIGER-Lab/Video_Eval", filename="all_50k/train_50k_for_mantis/frames_inc.zip", repo_type="dataset", local_dir="./data")
# hf_hub_download(repo_id="TIGER-Lab/Video_Eval", filename="all_50k/train_50k_for_mantis/frames_insf.zip", repo_type="dataset", local_dir="./data")
# hf_hub_download(repo_id="TIGER-Lab/Video_Eval", filename="all_50k/train_50k_for_mantis/frames_lab.zip", repo_type="dataset", local_dir="./data")
# hf_hub_download(repo_id="TIGER-Lab/Video_Eval", filename="all_50k/train_50k_for_mantis/frames_real.zip", repo_type="dataset", local_dir="./data")   
