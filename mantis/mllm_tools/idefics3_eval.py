...
class Idefics3():
    ...
    def __init__(self, model_path:str="HuggingFaceM4/Idefics3-8B-Llama3") -> None:
        """Llava model wrapper
        ...
        self.model = self.model_class.from_pretrained(model_path, device_map="auto", torch_dtype=torch.float16, _attn_implementation=attn_implementation).eval()
        self.processor = self.processor_class.from_pretrained("HuggingFaceM4/Idefics3-8B-Llama3")
            ...
            messages = [
                {
                    ...
                    "content": [ {"type": "image"} if x["type"] == "image" else {"type": "text", "text": text_prompt} for x in inputs]
                }
            ]
...
class MantisIdefics3(Idefics3):
    model_class = Idefics3ForConditionalGeneration
    processor_class = Idefics3Processor
    def __init__(self, model_path:str="Mantis-VL/mantis-8b-idefics3_16384") -> None:
