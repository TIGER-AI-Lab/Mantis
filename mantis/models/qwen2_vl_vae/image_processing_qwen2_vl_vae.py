...
class Qwen2VLVAEImageProcessor(BaseImageProcessor):
    ...
    def __init__(
        ...
        patch_size: int = 2,
        temporal_compression_rate: int = 6,
        height_compression_rate: int = 8,
        width_compression_rate: int = 8,
        merge_size: int = 2,
        **kwargs,
    ) -> None:
        ...
        self.temporal_compression_rate = temporal_compression_rate
        self.height_compression_rate = height_compression_rate
        self.width_compression_rate = width_compression_rate
    ...
    def _preprocess(
        ...
        num_final_tokens = smart_estimate_vae_tokens(
            ...
            height,
            width,
            temporal_compression_rate=self.temporal_compression_rate,
            height_compression_rate=self.height_compression_rate,
            width_compression_rate=self.width_compression_rate,
            patch_size=self.patch_size,
        )
        return patches, num_final_tokens
