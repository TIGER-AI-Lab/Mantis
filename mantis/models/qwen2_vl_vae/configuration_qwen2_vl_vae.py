...
class Qwen2VLVisionVAEConfig(PretrainedConfig):
...
class Qwen2VLVAEConfig(PretrainedConfig):
    r"""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if isinstance(vision_config, dict):
            self.vision_config = Qwen2VLVisionVAEConfig(**vision_config)
        elif vision_config is None:
            self.vision_config = Qwen2VLVisionVAEConfig()
